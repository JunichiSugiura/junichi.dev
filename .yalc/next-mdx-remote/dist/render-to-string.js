...
var babel_plugin_mdx_browser_1 = __importDefault(require("./babel-plugin-mdx-browser"));
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    component = new (Function.bind.apply(Function, __spreadArrays([void 0, 'React',
                        'MDXProvider',
                        'mdx',
                        'components'], Object.keys(scope), [now.code + "\nreturn React.createElement(MDXProvider, { components },\n  React.createElement(MDXContent, {})\n);"])))().apply(void 0, __spreadArrays([react_2.default, react_1.MDXProvider, react_1.mdx, components], Object.values(scope)));
                    return [2 /*return*/, {
                            source: later.code,
